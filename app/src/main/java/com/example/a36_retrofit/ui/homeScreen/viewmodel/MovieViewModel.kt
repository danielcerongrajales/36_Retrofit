...
@HiltViewModel
 class MovieViewModel @Inject constructor(val getPopularMoviesUseCase: GetPopularMoviesUseCase, val getTopRatedMovieUseCase: GetTopRatedMoviesUseCase, val connectivityManager: ConnectivityManager,) :
    ViewModel() {
